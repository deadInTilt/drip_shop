...
class ProductSeeder extends Seeder
{
    public function run(): void
    {
        Product::insert([
            ...
            ['title' => 'Nike Air Max 90',
                'description' => 'Мужские кроссовки Nike Air Max 90 Leather гарантируют полный комфорт благодаря амортизирующей вставке Max Air в области пятки и верху с накладками для поддержки в ключевых зонах. Верх с кожаными накладками обеспечивает поддержку и прочность. Полноразмерная промежуточная подошва из материала PU обеспечивает амортизацию и устойчивость. Резиновая вафельная подошва обеспечивает превосходное сцепление.',
                'preview_image' => 'images/shoes/90_orange.webp',
                'quantity' => '10',
                'price' => '11999.00',
                'brand_id' => '1',
                'category_id' => '2',
            ...
            ['title' => 'NIKE SHOX TL',
                'description' => 'Поднимите свой образ на новый уровень с женскими кроссовками Nike Shox TL. Благодаря воздухопроницаемому сетчатому верху и технологии Nike Shox классическая версия 2003 года была переосмыслена для превосходной амортизации и привлекательного уличного стиля.',
                'preview_image' => 'images/shoes/shox.webp',
                'quantity' => '10',
                'price' => '15999.00',
                'brand_id' => '1',
                'category_id' => '2',
            ...
            ['title' => 'AIR MAX DN',
                'description' => 'Кроссовки Nike Air Max Dn - культовое продолжение коллекции Nike Air Max. Модель оснащена новейшей технологией амортизации Dynamic Air, а именно двухкамерной вставкой Nike Air с четырьмя трубками, обеспечивающей исключительное сочетание комфорта, плавного шага и оптимального отскока. Бесшовный верх, боковая поддержка из ТПУ и оригинальные цветовые решения, органично сочетают в себе стиль и спорт.',
                'preview_image' => 'images/shoes/nike_dn.webp',
                'quantity' => '100',
                'price' => '29999.00',
                'brand_id' => '1',
                'category_id' => '1',
